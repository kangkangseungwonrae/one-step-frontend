      ...
      <funnel.Render
        step1={({ context, history }) => (
          <Step1
            ...
            onNext={(selectedId: number) =>
              history.push("step2", { selectedId })
            }
          />
        )}
        ...
        step3={({ context, history }) => (
          <Step3
            selectedId={context.selectedId}
            onNext={(selectedId: number, curTime: number) =>
              history.push("step4", { selectedId, curTime })
            }
          />
        )}
        step4={({ context }) => (
